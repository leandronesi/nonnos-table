...
/**
 * Player stat card — sotto il hero "Today's Session".
 *
 * NON è più la hero (quella è TodaySession). Qui mostriamo i NUMERI duri del
    ...
    <div className="surface surface-padded fade-in fade-in-delay-1">
      <div className="flex items-baseline justify-between flex-wrap gap-3 mb-4">
        <div className="flex items-baseline gap-3">
          <span className="label-eyebrow">Goal · {goal.time_class} entro {goal.deadline}</span>
